                    ...
                    <a href="{{ route('shop.show', $product) }}"
                       class="block bg-white rounded-lg border p-4 hover:shadow-md transition">
                        ...
                        @elseif ($product->stock < 5)
                            <span class="text-xs text-orange-600">Plus que {{ $product->stock }} en stock</span>
                        @endif
                    </a>
                @empty
                    <p class="text-gray-500 col-span-full">Aucun produit disponible pour le moment.</p>
                @endforelse
            </div>
